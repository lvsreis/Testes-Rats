...
// on quarta-feira, 21 de abril de 2021 at 16:11:07.
...
public final class closure extends ParserBase {
  ...
  /** Actually parse closure.$$Shared4. */
  ...
  /**
   * Parse nonterminal closure.QUERY.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal closure.HTAG.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
